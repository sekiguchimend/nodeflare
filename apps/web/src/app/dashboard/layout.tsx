    ...
    <div className="min-h-screen flex">
      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-16'} border-r bg-card transition-all duration-300`}>
        ...
        <nav className="p-4 space-y-2">
          ...
          <NavLink href="/dashboard/billing" icon={<svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2" /><line x1="1" y1="10" x2="23" y2="10" /></svg>} collapsed={!sidebarOpen}>Billing</NavLink>
